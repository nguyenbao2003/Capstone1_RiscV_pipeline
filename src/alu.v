...
module alu(
   ...
   wire signed [31:0] SrcBE_signed = SrcBE;
   ...
   begin
		case(ALUControlE)
        5'b00000: ALU_Result =   SrcAE + SrcBE ;  // add
        5'b00001: ALU_Result =   SrcAE - SrcBE ;  // sub
        5'b00010: ALU_Result =   SrcAE & SrcBE;	  // and, andi
        5'b00011: ALU_Result =   SrcAE | SrcBE;   // or, ori
        5'b00100: ALU_Result =   SrcAE<< SrcBE;   // sll, sli
        5'b00101: ALU_Result =  (SrcAE_signed < SrcBE_signed)  ? 32'd1 : 32'd0 ; // slt, slti
    //  5'b00110: ALU_Result =  {SrcAE[30:0],SrcAE[31]};
    //  5'b00111: ALU_Result =  {SrcAE[0],SrcAE[31:1]}; // sra, srai
		  5'b00111: ALU_Result =  SrcAE >>> SrcBE ;    // sra, srai
        5'b01000: ALU_Result =   (SrcAE < SrcBE)  ? 32'd1 : 32'd0; // sltu, sltiu
    //  5'b01001: ALU_Result =   SrcAE / SrcBE;
        5'b01010: ALU_Result =   SrcAE ^ SrcBE; // xor
    //  5'b01011: ALU_Result = ~(SrcAE | SrcBE); // nor
    //  5'b01100: ALU_Result = ~(SrcAE & SrcBE); //nand
    //  5'b01101: ALU_Result = ~(SrcAE ^ SrcBE); // xnor
        5'b01110: ALU_Result =  SrcAE>> SrcBE; // srl, srli
